// Launch and drive a desktop (GUI) application.
//
// The agent needs three things to debug a desktop app the way a person does:
// start it and keep its stdout/stderr (that is where crashes, tracebacks and
// GTK/Qt criticals show up), look at its windows (list/focus/screenshot), and
// act on it (click, type, keys). X11 input injection goes through xdotool when
// it is installed; everything else degrades to a clear, actionable message
